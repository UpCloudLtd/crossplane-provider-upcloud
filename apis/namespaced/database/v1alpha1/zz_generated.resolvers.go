...
import (
	"context"
	v1alpha1 "github.com/UpCloudLtd/crossplane-provider-upcloud/apis/namespaced/network/v1alpha1"
...
// ResolveReferences of this ManagedDatabaseValkey.
func (mg *ManagedDatabaseValkey) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
