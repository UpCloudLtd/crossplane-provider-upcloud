...
type EndpointObservation struct {
	...
	// (String) Domain name of the endpoint.
...
type ManagedObjectStorageObservation struct {
	...
	// (Attributes Set) Endpoints for accessing the Managed Object Storage service. (see below for nested schema)
	Endpoint []EndpointObservation `json:"endpoint,omitempty" tf:"endpoint,omitempty"`

	// (String) The UUID of the managed object storage instance.
