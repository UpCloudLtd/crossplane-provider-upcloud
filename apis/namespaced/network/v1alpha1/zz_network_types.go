...
type DHCPRoutesConfigurationInitParameters struct {
	...
	// (Attributes) Automatically populate effective routes. (see below for nested schema)
	EffectiveRoutesAutoPopulation *EffectiveRoutesAutoPopulationInitParameters `json:"effectiveRoutesAutoPopulation,omitempty" tf:"effective_routes_auto_population,omitempty"`
}

type DHCPRoutesConfigurationObservation struct {

	// (Attributes) Automatically populate effective routes. (see below for nested schema)
	EffectiveRoutesAutoPopulation *EffectiveRoutesAutoPopulationObservation `json:"effectiveRoutesAutoPopulation,omitempty" tf:"effective_routes_auto_population,omitempty"`
}

type DHCPRoutesConfigurationParameters struct {

	// (Attributes) Automatically populate effective routes. (see below for nested schema)
	// +kubebuilder:validation:Optional
	EffectiveRoutesAutoPopulation *EffectiveRoutesAutoPopulationParameters `json:"effectiveRoutesAutoPopulation,omitempty" tf:"effective_routes_auto_population,omitempty"`
}

type EffectiveRoutesAutoPopulationInitParameters struct {

	// population.
	// Enable or disable route auto-population.
	Enabled *bool `json:"enabled,omitempty" tf:"enabled,omitempty"`

	// connected-networks, static-route).
	// Exclude routes coming from specific sources (router-connected-networks, static-route).
	// +listType=set
	ExcludeBySource []*string `json:"excludeBySource,omitempty" tf:"exclude_by_source,omitempty"`

	// populating routes.
	// CIDR destinations to include when auto-populating routes.
	// +listType=set
	FilterByDestination []*string `json:"filterByDestination,omitempty" tf:"filter_by_destination,omitempty"`

	// (Set of String) Include only routes of given types (service, user).
...
type EffectiveRoutesAutoPopulationObservation struct {
...
type EffectiveRoutesAutoPopulationParameters struct {
...
type IPNetworkInitParameters struct {
	...
	// population configuration. (see below for nested schema)
	DHCPRoutesConfiguration *DHCPRoutesConfigurationInitParameters `json:"dhcpRoutesConfiguration,omitempty" tf:"dhcp_routes_configuration,omitempty"`
...
type IPNetworkObservation struct {
	...
	// population configuration. (see below for nested schema)
	DHCPRoutesConfiguration *DHCPRoutesConfigurationObservation `json:"dhcpRoutesConfiguration,omitempty" tf:"dhcp_routes_configuration,omitempty"`
...
type IPNetworkParameters struct {
	...
	// population configuration. (see below for nested schema)
	// +kubebuilder:validation:Optional
	DHCPRoutesConfiguration *DHCPRoutesConfigurationParameters `json:"dhcpRoutesConfiguration,omitempty" tf:"dhcp_routes_configuration,omitempty"`
...
type NetworkInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/UpCloudLtd/crossplane-provider-upcloud/apis/namespaced/network/v1alpha1.Router
