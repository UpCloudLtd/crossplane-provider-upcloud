...
type KubernetesClusterInitParameters struct {
	...
	// (String) The pricing plan used for the cluster. You can list available plans with upctl kubernetes plans.
	...
	UpgradeStrategyType *string `json:"upgradeStrategyType,omitempty" tf:"upgrade_strategy_type,omitempty"`

	// (String) Kubernetes version ID, e.g. 1.31. You can list available version IDs with upctl kubernetes versions.
