...
type ManagedObjectStorageUserPolicyInitParameters struct {
	...
	// (String) Policy name.
	// Policy name.
	// +crossplane:generate:reference:type=github.com/UpCloudLtd/crossplane-provider-upcloud/apis/cluster/objectstorage/v1alpha1.ManagedObjectStoragePolicy
...
type ManagedObjectStorageUserPolicyObservation struct {
	...
	// (String) ID of the user. ID is in {object storage UUID}/{username}/{policy name} format.
