...
func (tr *Server) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithNameFilter("CPU"))
	opts = append(opts, resource.WithNameFilter("Mem"))
	opts = append(opts, resource.WithNameFilter("Plan"))
