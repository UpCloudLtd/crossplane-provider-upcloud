...
func (in *DHCPRoutesConfigurationInitParameters) DeepCopyInto(out *DHCPRoutesConfigurationInitParameters) {
	*out = *in
	if in.EffectiveRoutesAutoPopulation != nil {
		in, out := &in.EffectiveRoutesAutoPopulation, &out.EffectiveRoutesAutoPopulation
		*out = new(EffectiveRoutesAutoPopulationInitParameters)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DHCPRoutesConfigurationInitParameters.
func (in *DHCPRoutesConfigurationInitParameters) DeepCopy() *DHCPRoutesConfigurationInitParameters {
	if in == nil {
		return nil
	}
	out := new(DHCPRoutesConfigurationInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DHCPRoutesConfigurationObservation) DeepCopyInto(out *DHCPRoutesConfigurationObservation) {
	*out = *in
	if in.EffectiveRoutesAutoPopulation != nil {
		in, out := &in.EffectiveRoutesAutoPopulation, &out.EffectiveRoutesAutoPopulation
		*out = new(EffectiveRoutesAutoPopulationObservation)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DHCPRoutesConfigurationObservation.
func (in *DHCPRoutesConfigurationObservation) DeepCopy() *DHCPRoutesConfigurationObservation {
	if in == nil {
		return nil
	}
	out := new(DHCPRoutesConfigurationObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DHCPRoutesConfigurationParameters) DeepCopyInto(out *DHCPRoutesConfigurationParameters) {
	*out = *in
	if in.EffectiveRoutesAutoPopulation != nil {
		in, out := &in.EffectiveRoutesAutoPopulation, &out.EffectiveRoutesAutoPopulation
		*out = new(EffectiveRoutesAutoPopulationParameters)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DHCPRoutesConfigurationParameters.
func (in *DHCPRoutesConfigurationParameters) DeepCopy() *DHCPRoutesConfigurationParameters {
	if in == nil {
		return nil
	}
	out := new(DHCPRoutesConfigurationParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EffectiveRoutesAutoPopulationInitParameters) DeepCopyInto(out *EffectiveRoutesAutoPopulationInitParameters) {
	*out = *in
	if in.Enabled != nil {
	...
	if in.ExcludeBySource != nil {
		in, out := &in.ExcludeBySource, &out.ExcludeBySource
	...
	if in.FilterByDestination != nil {
		in, out := &in.FilterByDestination, &out.FilterByDestination
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.FilterByRouteType != nil {
		in, out := &in.FilterByRouteType, &out.FilterByRouteType
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EffectiveRoutesAutoPopulationInitParameters.
func (in *EffectiveRoutesAutoPopulationInitParameters) DeepCopy() *EffectiveRoutesAutoPopulationInitParameters {
	if in == nil {
		return nil
	}
	out := new(EffectiveRoutesAutoPopulationInitParameters)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EffectiveRoutesAutoPopulationObservation) DeepCopyInto(out *EffectiveRoutesAutoPopulationObservation) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EffectiveRoutesAutoPopulationObservation.
func (in *EffectiveRoutesAutoPopulationObservation) DeepCopy() *EffectiveRoutesAutoPopulationObservation {
	if in == nil {
		return nil
	}
	out := new(EffectiveRoutesAutoPopulationObservation)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EffectiveRoutesAutoPopulationParameters) DeepCopyInto(out *EffectiveRoutesAutoPopulationParameters) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EffectiveRoutesAutoPopulationParameters.
func (in *EffectiveRoutesAutoPopulationParameters) DeepCopy() *EffectiveRoutesAutoPopulationParameters {
	if in == nil {
		return nil
	}
	out := new(EffectiveRoutesAutoPopulationParameters)
...
func (in *IPNetworkInitParameters) DeepCopyInto(out *IPNetworkInitParameters) {
	*out = *in
	...
	if in.DHCPRoutesConfiguration != nil {
		in, out := &in.DHCPRoutesConfiguration, &out.DHCPRoutesConfiguration
		*out = new(DHCPRoutesConfigurationInitParameters)
		(*in).DeepCopyInto(*out)
	}
	if in.Family != nil {
